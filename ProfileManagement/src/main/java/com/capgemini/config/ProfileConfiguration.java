...
public class ProfileConfiguration extends WebMvcConfigurationSupport {
	...
	public Docket version1() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                ...
                .apiInfo(new ApiInfoBuilder().description("Profile Management")
                        .title("Profile Management").build());
}
